...
alter table zehn_01.PHARMACIST modify StoreId varchar2(10) not null;
ALTER TABLE zehn_01.PHARMACIST DROP UNIQUE(StoreId);
alter table zehn_01.RECEIPT DROP UNIQUE(PharmacistId);
...
truncate table zehn_01.RECEIPT;
truncate table zehn_01.RECEIPTDETAIL;
